...
const ChatPage = ({ event }) => {
  ...
  const [messages, setMessages] = useState([
    ...
    {
      id: 2,
      text: "Проверка длинного сообщения с автоматическим переносом строки. фффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффффф",
      timestamp: "12:31",
      sender: "me"
    }
